...
dsm <- rast("./data/week10/SJER2013_DSM.tif")

# digital terrain model (DTM)
dtm <- rast("./data/week10/SJER2013_DTM.tif")
```
...
plot_centroids <- st_read("./data/week10/PlotCentroids/SJERPlotCentroids_Buffer.shp")
...
veg_surveys <- read.csv("./data/week10/VegetationData/D17_2013_vegStr.csv") %>%
  group_by(plotid) %>%
