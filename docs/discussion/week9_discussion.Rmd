...
rasterizing polygon data - how to do it and why you might want to do it. you could also walk through why you vectorized raster data in assignment 3
masking based on multiple and more complex conditions
zonal statistics
I'm wondering if there's a way to incorporate the CA PA work that you already turned into discussion material for week 6
