...
-   use both base graphics (hint: use **plot()**) and **tmap** 
...
## question 2
Extend the **tmap** created for question 1 so the legend has three bins: "high" (HDI above 0.7), "medium" (HDI between 0.55 and 0.7), and "low" (HDI below 0.55).
