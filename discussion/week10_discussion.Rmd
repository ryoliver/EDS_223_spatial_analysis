...
1. Let's make nice plots of the California Protected areas Plot California protected areas by access level and by layer
...
p1 = ggplot(data = cpad_super) +
  ...
  annotation_north_arrow(location = "br",
                         pad_x = unit(0.2, "in"),
                         pad_y = unit(0.2, "in"),
                         style = ggspatial::north_arrow_nautical(fill = 
                                                                   c("grey40", "white"),
                                                                 line_col = "grey20"))
```

```{r}
p2 = ggplot(data = cpad_super) +
