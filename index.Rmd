...
-   **Office hours:** Monday 11-12pm PT (NCEAS)
...
|------|----------------|------------|
| 1    | Course overview & intro to spatial analysis| CRS, map making     |
| 2    | Spatial data models & intro to vector data| 'sf', attribute data operations|
| 3    | Vector operations | vector spatial & geometry operations|
| 4    | Spatial data science expert panel| review|
| 5    | Intro to raster data| 'terra', raster spatial operations|
| 6    | Intro to RS & EM radiation| no class |
| 7    | RS data collection | explatory analysis     |
| 8    | Hyper-spectral expert panel         | raster geometry operations     |
| 9    | Passive RS analysis          | band math, PCA     |
| 10   | Active RS & advanced analysis        | spatial stats basic     |
